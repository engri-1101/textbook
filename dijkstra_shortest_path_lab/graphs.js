...
function Graph1(rsr){
    ...
    refreshh = rsr.rect(93.467216, 187.53175, 40,40).attr({id: 'refresh-h',x: '98.467216',y: '187.53175',ry: '0.48161307',parent: 'layer5',opacity: '0',fill: '#8e8d8a',"fill-opacity": '1',stroke: '#8e8d8a',"stroke-width": '3.5',"stroke-miterlimit": '4',"stroke-dasharray": 'none',"stroke-opacity": '1'}).data('id', 'refreshh');
