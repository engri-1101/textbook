...
function Graph1(rsr){
    ...
    refresh = rsr.set();
    var path907 = rsr.path("m 50.362914,240.16111 c 1.582786,-1.58279 3.769384,-2.56176 6.184633,-2.56176 4.830499,0 8.746392,3.91589 8.746395,8.74639 3e-6,4.8305 -3.915892,8.7464 -8.746395,8.7464 -4.830503,0 -8.746398,-3.9159 -8.746395,-8.7464").attr({id: 'path907',parent: 'layer2',opacity: '1',fill: 'none',"fill-opacity": '1',stroke: '#8e8d8a',"stroke-width": '1.3',"stroke-miterlimit": '4',"stroke-dasharray": 'none',"stroke-opacity": '1'}).transform("m0.68898241,-0.68898241,0.68898241,0.68898241,-123.01125,69.765656").data('id', 'path907');
    var path927 = rsr.path("m 47.508873,245.2886 c 2.245059,2.24505 2.250905,2.2509 2.250905,2.2509").attr({id: 'path927',parent: 'layer2',fill: 'none',stroke: '#8e8d8a',"stroke-width": '1',"stroke-linecap": 'butt',"stroke-linejoin": 'miter',"stroke-miterlimit": '4',"stroke-dasharray": 'none',"stroke-opacity": '1'}).transform("m0.68898241,-0.68898241,0.68898241,0.68898241,-123.01125,69.765656").data('id', 'path927');
    var path9273 = rsr.path("m 48.199798,245.29879 c -2.24506,2.24506 -2.2509,2.2509 -2.2509,2.2509").attr({id: 'path927-3',parent: 'layer2',fill: 'none',stroke: '#8e8d8a',"stroke-width": '1',"stroke-linecap": 'butt',"stroke-linejoin": 'miter',"stroke-miterlimit": '4',"stroke-dasharray": 'none',"stroke-opacity": '1'}).transform("m0.68898241,-0.68898241,0.68898241,0.68898241,-123.01125,69.765656").data('id', 'path9273');
    ...
    edith = rsr.rect(32.233482, 187.74106, 24.070456, 24.698381).attr({id: 'edit-h',x: '32.233482',y: '187.74106',ry: '0.48161307',parent: 'layer5',opacity: '0',fill: '#8e8d8a',"fill-opacity": '1',stroke: '#8e8d8a',"stroke-width": '3.5',"stroke-miterlimit": '4',"stroke-dasharray": 'none',"stroke-opacity": '1'}).data('id', 'edith');
    refreshh = rsr.rect(73.467216, 187.53175, 25.744923, 25.954231).attr({id: 'refresh-h',x: '73.467216',y: '187.53175',ry: '0.48161307',parent: 'layer5',opacity: '0',fill: '#8e8d8a',"fill-opacity": '1',stroke: '#8e8d8a',"stroke-width": '3.5',"stroke-miterlimit": '4',"stroke-dasharray": 'none',"stroke-opacity": '1'}).data('id', 'refreshh');
    verifyh = rsr.rect(110.09617, 186.69452, 31.814865, 28.047314).attr({id: 'verify-h',x: '110.09617',y: '186.69452',ry: '0.48161307',parent: 'layer5',opacity: '0',fill: '#8e8d8a',"fill-opacity": '1',stroke: '#8e8d8a',"stroke-width": '3.5',"stroke-miterlimit": '4',"stroke-dasharray": 'none',"stroke-opacity": '1'}).data('id', 'verifyh');
    ffh = rsr.rect(155.09746, 187.74106, 27.210083, 24.489073).attr({id: 'ff-h',x: '155.09746',y: '187.74106',ry: '0.48161307',parent: 'layer5',opacity: '0',fill: '#8e8d8a',"fill-opacity": '1',stroke: '#8e8d8a',"stroke-width": '3.5',"stroke-miterlimit": '4',"stroke-dasharray": 'none',"stroke-opacity": '1'}).data('id', 'ffh');
