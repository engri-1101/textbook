...
def format(game_parts, automate_button_row_max_width = 400,
    ...
    automate_button_row = row(game_parts.buttons['b_automate'],
                              game_parts.sliders['iterations_slider'],
                              game_parts.buttons['b_auto_next'],
                              max_width = automate_button_row_max_width,
                              sizing_mode = automate_button_row_sizing_mode)

    strategy_dropdown_row = row(game_parts.dropdowns['strategy_dropdown'],
                                max_width = strategy_dropdown_row_max_width,
                                sizing_mode = strategy_dropdown_row_sizing_mode)

    start_automate_row = row(game_parts.buttons['b_start_automate'],
                             game_parts.buttons['b_make_counter'],
                             max_width = start_automate_row_max_width,
                             sizing_mode = start_automate_row_sizing_mode)

    automate_LL_aim_row = row(game_parts.textinputs['ll_aim_text_input'],
                              max_width = automate_aim_rows_max_width,
                              sizing_mode = automate_aim_rows_sizing_mode)
    automate_LM_aim_row = row(game_parts.textinputs['lm_aim_text_input'],
                              max_width = automate_aim_rows_max_width,
                              sizing_mode = automate_aim_rows_sizing_mode)
    automate_LR_aim_row = row(game_parts.textinputs['lr_aim_text_input'],
                              max_width = automate_aim_rows_max_width,
                              sizing_mode = automate_aim_rows_sizing_mode)
    automate_RL_aim_row = row(game_parts.textinputs['rl_aim_text_input'],
                              max_width = automate_aim_rows_max_width,
                              sizing_mode = automate_aim_rows_sizing_mode)
    automate_RM_aim_row = row(game_parts.textinputs['rm_aim_text_input'],
                              max_width = automate_aim_rows_max_width,
                              sizing_mode = automate_aim_rows_sizing_mode)
    automate_RR_aim_row = row(game_parts.textinputs['rr_aim_text_input'],
                              max_width = automate_aim_rows_max_width,
                              sizing_mode = automate_aim_rows_sizing_mode)

    game_stats_row_1 = row(game_parts.figures['game_stats_figure_1'],
                           game_parts.figures['game_stats_figure_2'],
                           max_width = game_stats_row_1_max_width,
                           sizing_mode = game_stats_row_1_sizing_mode)
    game_stats_row_2 = row(game_parts.figures['game_stats_figure_3'],
                           game_parts.figures['game_stats_figure_4'],
                           max_width = game_stats_row_2_max_width,
                           sizing_mode = game_stats_row_2_sizing_mode)

    b_fig_1_row = row(game_parts.buttons['b_fig_1'],
                      max_width = b_fig_rows_max_width,
                      sizing_mode = b_fig_rows_sizing_mode)
    b_fig_2_row = row(game_parts.buttons['b_fig_2'],
                      max_width = b_fig_rows_max_width,
                      sizing_mode = b_fig_rows_sizing_mode)
    b_fig_3_row = row(game_parts.buttons['b_fig_3'],
                      max_width = b_fig_rows_max_width,
                      sizing_mode = b_fig_rows_sizing_mode)
    b_fig_4_row = row(game_parts.buttons['b_fig_4'],
                      max_width = b_fig_rows_max_width,
                      sizing_mode = b_fig_rows_sizing_mode)
    ...
    gui_column2 = column(b_fig_1_row, b_fig_2_row, b_fig_3_row, b_fig_4_row,
                         ...
                         automate_RR_aim_row,
                         game_parts.tables['automation_table'],
                         game_parts.tables['automation_distribution_table'],
