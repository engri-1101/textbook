...
#This code string changes the game's text to display the iterations played
#and the game score.
automate_loop_iteration_display = """
function iteration_display(){
...
#Runs the fictitious_play_goalie_strategy
run_fictitious_play = """
...
#This code string animates the game.
...
#This code string tracks some of the game data in a table.
