...
def create(game_parts, config):
    ...
    automation_distribution_table = DataTable(source = game_parts.sources['distribution_table'],
                                              ...
                                              fit_columns = config.fit_columns)
