...
class Configs():
    ...
    def __init__(
        ...
        plot_width=600, plot_height=400, x_range=(0, 100), y_range=(0, 90),
        xaxis_visible=False, yaxis_visible=False, xgrid_line_color=None,
        ...
        mline_goal_xs=[34, 34, 66, 66], mline_goal_ys=[63, 82, 82, 63],
        mline_penaltybox_color_1="lightgreen",
        mline_penaltybox_color_2="lightgreen", mline_goal_color="whitesmoke",
        mline_penaltybox_alpha_1=1, mline_penaltybox_alpha_2=1,
        mline_goal_alpha=1, mline_line_width=4, penaltyarc_quad_x1=33,
        penaltyarc_quad_y1=15, penaltyarc_quad_x2=67, penaltyarc_quad_y2=15,
        ...
        goalie_body_angle=0, goalie_body_color="red", goalie_body_line_width=2,
        ball_x=50, ball_y=13, ball_fill_color="whitesmoke", ball_line_width=2,
        ...
        striker_body_width=4, striker_body_height=6, striker_body_angle=0,
...
def create(game_parts, configs=Configs()):
    ...
    ys = [
        configs.mline_penaltybox_ys_1, configs.mline_penaltybox_ys_2,
        configs.mline_goal_ys
    ]
    color = [
        configs.mline_penaltybox_color_1, configs.mline_penaltybox_color_2,
        configs.mline_goal_color
    ]
    alpha = [
        configs.mline_penaltybox_alpha_1, configs.mline_penaltybox_alpha_2,
    ...
    goalie_head = Circle(
        ...
        line_width=configs.goalie_head_line_width, size=configs.goalie_head_size
    )
    goalie_body = Rect(
    ...
    striker_body = Rect(
        ...
        width=configs.striker_body_width, height=configs.striker_body_height,
