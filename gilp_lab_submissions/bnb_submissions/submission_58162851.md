...
**A:** the relational optimal value gives the max IP optimal value, or the min for a minimization problem
...
**A:** because the LP relation gives the maximum, therefore it is the optimal solution

**Q5:** If the LP is infeasible, then the IP is infeasible. Explain why this is true.

**A:** If there exists no LP it is impossible to derive an IP
...
```
    ...
    <ipython-input-1-d2b7cd88a357> in <module>
    ----> 1 data = pd.read_csv('knapsack_data_1.csv', index_col=0)
          2 data
...
**A:** we can take 1 of eacitem


```python
# TODO: replace index
# data = data.drop(#index)
data = pd.read_csv('knapsack_data_1.csv', index_col=1)
```
    ...
    <ipython-input-2-520be18f9f00> in <module>
          1 # TODO: replace index
          2 # data = data.drop(#index)
    ----> 3 data = pd.read_csv('knapsack_data_1.csv', index_col=1)
...
```
    ...
    <ipython-input-3-9675c2a9f340> in <module>
    ----> 1 data['value per unit weight'] = (data['value'] / data['weight']).round(2)
          2 data
...
**A:** start with the highest value item, then go from there
...
```
    ...
    <ipython-input-6-041df17acbb8> in <module>
...
```
    ...
    <ipython-input-7-af19a07ed2af> in <module>
          1 # Template
    ----> 2 m, x = Knapsack(data, 18)
          3 # Add constraints here
          4 
          5 solve(m)
...
```
    ...
    <ipython-input-8-4ed4dd53b730> in <module>
...
```
    ...
    <ipython-input-9-a7a33266d6aa> in <module>
...
```
    ...
    <ipython-input-11-c5d79fee6538> in <module>
