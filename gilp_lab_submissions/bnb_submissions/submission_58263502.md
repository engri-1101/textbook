...
**A:** yes because 44.5 is the upper bound and 44 is less than 44.5
...
**A:**Because it is either the lower or upper bound so any other integer will not be as good a solution
...
**A:**  because if the bound is infeasible so would the integer 
...
```
    ...
    <ipython-input-4-af19a07ed2af> in <module>
          1 # Template
