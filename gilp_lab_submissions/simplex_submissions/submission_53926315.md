...
**A:** **I already submitted part 1 in the previous lab hence I am leaving these questions empty**
...
**A:** Yes, linear constraints are just one line. there is no ambiguity int their representation
...
**A:** No because in 3d space the first is a plane (x_3 is free var) whereas the second is a line.

**Q8:** Based on your answers to **Q6** and **Q7**, do you think there exists a unique way to write any given LP?

**A:** If we are restricted to a certain dimensional space then yes
...
**A:** optimal solution is 2,4,5,1,2. 
...
**A:** Yes it is in dictionary form
...
**A:** objective value is 12. and yes, the feasible solution is equal to the objective value because it is in LP dictionary form.
...
**A:** that it doesnt violate other constraints on x1 itself.
...
**A:** 3,1,2,4 thus second one is most limiting
...
**A:** The corresponding solution is 2,3,1,4,5.
...
**A:** feasible is optimal solution
...
**A:** travelling to a different corner point
